    ...
    <section>
        ...
        <div class="d-flex flex-wrap container justify-content-between">
            ...
            <div class="card m-3" style="width: 18rem;">
                ...
                <div class="card-body">
                  <h5 class="card-title"><a href="/portfolios/{{ $portfolio->id }}" class="text-decoration-none"><b>{{ $portfolio->nom }}</b></a>  </h5>
                </div>
                ...
                <div class="card-body d-flex flex-column" >
                  <a href="/portfolios/{{ $portfolio->id }}/download" class="btn btn-success" class="download" style="color:white">Download</a>
                  <a href="/portfolios/{{ $portfolio->id }}/edit" class="btn btn-warning" class="edit" style="color:white;">Edit</a>
